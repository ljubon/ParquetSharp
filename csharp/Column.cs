...
namespace ParquetSharp
{
    ...
    public class Column
    {
        public Column(Type logicalSystemType, string name, LogicalType? logicalTypeOverride = null) : this(logicalSystemType, name, logicalTypeOverride, GetTypeLength(logicalSystemType))
        {
        ...
        private static (LogicalType LogicalType, PhysicalType PhysicalType) GetEntry(LogicalType? logicalTypeOverride, LogicalType? logicalType, PhysicalType physicalType)
        {
        ...
        private static readonly IReadOnlyDictionary<Type, (Repetition Repetition, LogicalType? LogicalType, PhysicalType PhysicalType)> Primitives = new Dictionary<Type, (Repetition, LogicalType?, PhysicalType)>
        {
    ...
    {
        public Column(string name, LogicalType? logicalTypeOverride = null) : base(typeof(TLogicalType), name, logicalTypeOverride)
        {
        }
    }
}