...
namespace ParquetSharp
{
    ...
    {
        public ColumnEncryptionPropertiesBuilder(string columnName) : this(Make(columnName))
        {
        }

        public ColumnEncryptionPropertiesBuilder(ColumnPath columnPath) : this(Make(columnPath))
        {
        }
